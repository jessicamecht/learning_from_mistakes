...
parser.add_argument('--model_path', type=str, default='./state_dicts/cifar10_model.pt', help='path of pretrained model')#'EXP/model.pt'
parser.add_argument('--auxiliary', action='store_true', default=True, help='use auxiliary tower')#changed to true default
