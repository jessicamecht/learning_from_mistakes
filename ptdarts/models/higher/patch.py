...
from ptdarts.models.higher import utils as _utils
...
def _make_functional(
    ...
    print('memory_allocatedtmemory_reserved4', _torch.cuda.memory_allocated() / 1e9, 'memory_reserved',
          _torch.cuda.memory_reserved() / 1e9)
    param_names = list(
        name for name in module._parameters.keys()
        if module._parameters[name] is not None
    )
    print('memory_allocatedtmemory_reserved5', _torch.cuda.memory_allocated() / 1e9, 'memory_reserved',
          _torch.cuda.memory_reserved() / 1e9)
    ...
    print('memory_allocatedtmemory_reserved6', _torch.cuda.memory_allocated() / 1e9, 'memory_reserved',
          _torch.cuda.memory_reserved() / 1e9)
    fmodule = MonkeyPatched(module.parameters(), root=root_patched)
    print('memory_allocatedtmemory_reserved7', _torch.cuda.memory_allocated() / 1e9, 'memory_reserved',
          _torch.cuda.memory_reserved() / 1e9)
...
def _update_patched_params(
    ...
    print('memory_allocatedtmemory_reserved8', _torch.cuda.memory_allocated() / 1e9, 'memory_reserved',
              _torch.cuda.memory_reserved() / 1e9)
