        ...
        for i in range(task_num):
            with higher.innerloop_ctx(
                ...
                for _ in range(n_inner_iter):
                    ...
                    print('memory_allocatedtlastljhkjhkjhkjlhkjh', torch.cuda.memory_allocated() / 1e9, 'memory_reserved',
                          torch.cuda.memory_reserved() / 1e9)
                ...
                print('memory_allocatedtmeiu', torch.cuda.memory_allocated() / 1e9, 'memory_reserved',
                      torch.cuda.memory_reserved() / 1e9)
                ...
                print('memory_allocatedtlastneu', torch.cuda.memory_allocated() / 1e9, 'memory_reserved',
                      torch.cuda.memory_reserved() / 1e9)
                ...
                qry_loss.backward()
                print('memory_allocatedtbackw', torch.cuda.memory_allocated() / 1e9, 'memory_reserved',
                      torch.cuda.memory_reserved() / 1e9)
