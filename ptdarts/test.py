...
if __name__ == "__main__":
   ...
   # GPUtil.showUtilization()
    count_tensors(app="5")
    del inp, inp_val, targ, targ_val, model, visual_encoder_model, coefficient_vector, w_optim, test_data, test_loader, val_data, valid_loader, root, train_data, train_size
    gc.collect()
    torch.cuda.empty_cache()
